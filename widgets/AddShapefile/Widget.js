var widgetMap;
define(['dojo/_base/declare', 'dojo/_base/lang', 'dojo/aspect', 'dojo/Deferred', "dojo/dom", "dojo/json", "dojo/on", "dojo/parser", "dojo/sniff", "dojo/_base/array", 'dijit/_WidgetsInTemplateMixin', 'jimu/BaseWidget', 'jimu/portalUtils', 'jimu/dijit/Message', "esri/config", "esri/InfoTemplate", "esri/map", "esri/Color", "esri/request", "esri/geometry/scaleUtils", "esri/layers/FeatureLayer", "esri/renderers/SimpleRenderer", "esri/symbols/PictureMarkerSymbol", "esri/symbols/SimpleFillSymbol", "esri/symbols/SimpleLineSymbol"], function (declare, lang, aspect, Deferred, dom, JSON, on, parser, sniff, arrayUtils, _WidgetsInTemplateMixin, BaseWidget, PortalUtils, Message, esriConfig, InfoTemplate, Map, Color, request, scaleUtils, FeatureLayer, SimpleRenderer, PictureMarkerSymbol, SimpleFillSymbol, SimpleLineSymbol) {
            ...
            function changeRenderer(layer) {
                ...
                switch (layer.geometryType) {
                    ...
                    case 'esriGeometryPolygon':
                        symbol = new SimpleFillSymbol(SimpleFillSymbol.STYLE_SOLID, new SimpleLineSymbol(SimpleLineSymbol.STYLE_SOLID, new Color([112, 112, 112]), 1), new Color([136, 136, 136, 0.25]));
                        break;
                }
                if (symbol) {
